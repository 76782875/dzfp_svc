                ...
                if ("1".equals(jyls.getSffsyj()) && jyls.getGfemail() != null && !"".equals(jyls.getGfemail())) {
                    ...
                    if(f) {
                       ...
                       /* Map gsxxmap = new HashMap();
                        ...
                        QRCodeUtil.QRCodeCreate("http://fpjtest.datarj.com/einv/common/smInOut?serialOrder="+listkpls.get(0).getSerialorder(),GeneratePdfService.class.getClassLoader().getResource("/template/").getPath()+"ewm.jpg",25,null);
