...
public class FphcService {
	...
	//服务器纸票红冲
	public Map hccl1(Integer kplsh,Integer yhid, String gsdm,String hcjeStr,String xhStr,String hztzdh,String jylsh) throws Exception {
		...
		try {
			...
			String xml= GetXmlUtil.getFphczpXml(skp,kpls2.getFpzldm(), "1","00" ,kpspmxList2,kpls2);
			result.put("xml",xml);
